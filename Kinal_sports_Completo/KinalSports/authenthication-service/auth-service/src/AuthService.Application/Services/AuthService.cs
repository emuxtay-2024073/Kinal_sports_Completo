    ...
    ILogger<AuthService> logger) : IAuthService
{
    ...
    public async Task<RegisterResponseDto> RegisterAsync(RegisterDto registerDto)
    {
        ...
        if (string.IsNullOrWhiteSpace(registerDto.Password) || registerDto.Password.Trim().Length < 8)
        {
            throw new BusinessException(ErrorCodes.INVALID_INPUT, "La contraseña debe tener al menos 8 caracteres");
        }
